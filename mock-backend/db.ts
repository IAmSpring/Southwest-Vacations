    ...
    trips: [
      {
        ...
        price: 1299,
        description:
          'Experience the beauty of Hawaii with Southwest Airlines. Enjoy pristine beaches, volcanic landscapes, and rich cultural heritage.',
      ...
      },
      {
        ...
        price: 899,
        description:
          'Relax on the stunning beaches of Cancun with Southwest Airlines. Crystal-clear waters, vibrant nightlife, and ancient Mayan ruins await.',
      ...
      },
      {
        ...
        price: 599,
        description:
          'Experience the excitement of Las Vegas with Southwest Airlines. World-class entertainment, dining, and gaming in the heart of the desert.',
      ...
      },
      {
        ...
        price: 499,
        description:
          'Explore the natural beauty of Denver with Southwest Airlines. Mountain adventures, urban attractions, and breathtaking landscapes.',
      ...
      },
      {
        ...
        price: 699,
        description:
          'Discover the magic of Orlando with Southwest Airlines. World-famous theme parks, family attractions, and year-round sunshine.',
        datesAvailable: ['2025-05-01', '2025-06-01', '2025-07-01'],
        hotels: [
          {
            id: 'hotel5-1',
      ...
      },
      {
        ...
        price: 799,
        description:
          'Experience the charm of San Francisco with Southwest Airlines. Iconic landmarks, diverse neighborhoods, and stunning bay views.',
        datesAvailable: ['2025-05-15', '2025-06-15', '2025-07-15'],
        hotels: [
          {
            id: 'hotel6-1',
